...
import {
  MerchantAmazonProductsTaskPostTool,
  MerchantAmazonProductsTaskGetTool,
} from './tools/amazon/amazon-products.tool.js';
import {
  MerchantAmazonAsinTaskPostTool,
  MerchantAmazonAsinTaskGetTool,
} from './tools/amazon/amazon-asin.tool.js';
import {
  MerchantGoogleProductsTaskPostTool,
  MerchantGoogleProductsTaskGetTool,
} from './tools/google/google-products.tool.js';
import {
  MerchantAmazonLocationsTool,
  MerchantAmazonLanguagesTool,
  MerchantGoogleLocationsTool,
  MerchantGoogleLanguagesTool,

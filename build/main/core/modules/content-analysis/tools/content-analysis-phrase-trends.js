...
export class ContentAnalysisPhraseTrendsTool extends BaseTool {
    ...
    getParams() {
        ...
        Note: to match an exact phrase instead of a stand-alone keyword, use double quotes and backslashes;`),
            ...
            }).optional().describe(`target keyword fields and target keywords
        ...
        example:
        {
          ...
          "main_title": "sale"
            ...
            initial_dataset_filters: this.getFilterExpression().optional().describe(`initial dataset filtering parameters
        ...
        date format: "yyyy-mm-dd"`).optional(),
            ...
            internal_list_limit: z.number().min(1).max(20).default(1)
                .describe(`maximum number of elements within internal arrays
...
//# sourceMappingURL=content-analysis-phrase-trends.js.map
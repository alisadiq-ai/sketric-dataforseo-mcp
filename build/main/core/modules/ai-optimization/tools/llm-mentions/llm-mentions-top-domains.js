...
export class AiOptimizationLlmMentionsTopDomainsTool extends BaseTool {
    ...
    getParams() {
        return {
            ...
            initial_dataset_filters: this.getFilterExpression().optional().describe(`you can add several filters at once (8 filters maximum)
...
The full list of possible filters is available in 'ai_optimization_llm_mentions_filters' tool`),
    ...
    async handle(params) {
        try {
            ...
            const response = await this.dataForSEOClient.makeRequest(`/v3/ai_optimization/llm_mentions/top_domains/live`, 'POST', [payload]);
...
//# sourceMappingURL=llm-mentions-top-domains.js.map
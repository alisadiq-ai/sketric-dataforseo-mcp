...
export class AppDataAppleAppListingsSearchTool extends BaseTool {
    ...
    getParams() {
        return {
            ...
            location_code: z.number().optional().describe('location code (default 2840 = US). Get codes via app_data_apple_locations'),
...
//# sourceMappingURL=apple-app-listings-search.tool.js.map